...
<html>
  <head>
    ...
    <link rel="manifest" href="manifest.json?v=1.2.4.1">
  ...
  <body>
    ...
    <script src="assets/js/grid.js?v=1.2.4.1" async></script>

    <link rel="import" href="elements/thegrid/grid-app.html?v=1.2.4.1" async>
